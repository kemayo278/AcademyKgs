                  ...
                  <CardContent className="grid gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="grid gap-1">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">academy@kokitechgroup.com</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="grid gap-1">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">+237 698 456 987</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="grid gap-1">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Rue du Commandant Fuller Douala 
                          <br />
                          Face College Lasalle
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="grid gap-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400">8h00 - 21h00</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium">Samedi</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400">8h00 - 20h00</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium">Dimanche</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400">8h00 - 17h00</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="space-y-4">
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="grid gap-4">
                  ...
                  <Button type="submit" className="w-full bg-kokitech-blue">
                    Envoyer le message
                  </Button>
                </form>
              )}
