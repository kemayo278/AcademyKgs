...
const featuredCourses = [
  ...
  },
  {
    id: "2",
    title: "Sage Saari",
    description: "Maîtrisez Sage Saari pour la gestion de votre entreprise et la comptabilité.",
    price: "70000XAF",
    // image: "/placeholder.svg?height=250&width=350",
  ...
  {
    id: "3",
    title: "Batiment et Génie Civil",
    description: "Decouvrez les bases du génie civil et de la construction.",
    price: "80000XAF",
